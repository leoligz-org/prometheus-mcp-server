...
**Homepage:** <https://github.com/containers/prometheus-mcp-server>
...
```shell
helm upgrade -i -n prometheus-mcp-server --create-namespace prometheus-mcp-server oci://ghcr.io/containers/charts/prometheus-mcp-server --set ingress.host=<hostname>
```
...
| configFilePath | string | `"/etc/prometheus-mcp-server/config.toml"` |  |
